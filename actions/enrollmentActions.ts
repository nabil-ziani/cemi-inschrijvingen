...
export const enrollNewStudent = async (data: any, genderIsSelected: boolean) => {
    const supabase = createClient();
...
export const updateRefStudent = async (enrollment: EnrollmentWithStudentClass, data: any, genderIsSelected: boolean) => {
    const supabase = createClient();
